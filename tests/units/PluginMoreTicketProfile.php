      ...
      return [
          [
              ...
              'rights' => [
                  ...
                  ['name' => \TicketFollowup::$rightname, 'value' => \TicketFollowup::ADDMYTICKET, 'expected' => true],
                  ['name' => \TicketFollowup::$rightname, 'value' => \TicketFollowup::ADDALLTICKET, 'expected' => true],
              ],
          ]
      ];
   }
