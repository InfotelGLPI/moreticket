...
xgettext *.php */*.php --copyright-holder='Moreticket Development Team' --package-name='GLPI - Moreticket plugin' --package-version='1.2.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
