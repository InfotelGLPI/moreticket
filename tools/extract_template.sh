...
xgettext *.php */*.php --copyright-holder='MoreTicket Development Team' --package-name='GLPI - MoreTicket plugin' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
