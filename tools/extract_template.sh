...
xgettext *.php */*.php --copyright-holder='MoreTicket Development Team' --package-name='GLPI - MoreTicket plugin' --package-version='1.2.3' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
